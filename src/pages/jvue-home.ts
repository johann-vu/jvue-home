...
import "../components/jvue-project-card";
import "../components/jvue-skills-group";
import "../components/jvue-skill-item";
import { t, tr } from "../scripts/translation";
...
class AppHomePage extends LitElement {
  ...
  renderContact() {
    return tr("home.contact.rich", {
      linkedin: html`<a
        href="https://linkedin.com/in/jvue"
        target="_blank"
        rel="noopener noreferrer"
        >LinkedIn</a
      >`,
  ...
  renderProjectsSection() {
    return html`<h2 id="projects" class="section">
  ...
  renderSkillsSection() {
    return html`<h2 id="skills" class="section">${t("home.skills.heading")}</h2>
      <jvue-skills-group
        class="section"
      ...
      <jvue-skills-group
        class="section"
        title=${t("home.skills.frameworks.title")}
      >
        <jvue-skill-item
      ...
      <div class="wrapper">
        <div class="container hero-container">
          ...
          <div class="text-container">
            ...
            <p class="section">${t("home.hero.description")}</p>
          </div>
        </div>
        <div class="container">${this.renderProjectsSection()}</div>
        <div class="container">${this.renderSkillsSection()}</div>
        <div class="container">
